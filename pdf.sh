...
google-chrome --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./indexAmbientacion1001Ghules.html
...
google-chrome --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./indexCuentos1001Ghules.html
echo "Metas Cuentos"
...
google-chrome --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./indexBestiario1001Ghules.html
...
google-chrome --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./indexRecursos1001Ghules.html
echo "Metas Recursos"
